...
class SongListView {
	...
	public function render_song_list_view_page( $song_list_id = 0, $date = null ): string {
		...
		ob_start();
		require __DIR__ . '/templates/admin/song-list-view-page.php';
		return ob_get_clean();
	}
	...
	public function dmbc_render_song_list_delete_page(): string {
		...
		ob_start();
		require __DIR__ . '/templates/admin/song-list-delete-page.php';
		return ob_get_clean();
	}
	...
	public function render_song_list_table_page(): string {
		...
		if ( isset( $_GET['song_list_id'] ) ) {
			...
			return $this->generate_member_song_lists_table_page();
		}
	}
	...
	public function render_song_list_edit_page( $edit_id = 0 ): string {
		...
		$song_library_directory_path = $this->settings->get_song_library_directory_path();

		ob_start();
		require __DIR__ . '/templates/admin/song-list-edit-page.php';
		return ob_get_clean();
	}
	 ...
	 * @return bool|string
	 */
	public function generate_member_song_lists_table_page(): string|bool {
		$this->create_song_list_table();
		$this->song_list_table->prepare_items();
		$song_list_table = $this->song_list_table;

		ob_start();
		require __DIR__ . '/templates/admin/song-list-table-page.php';
		return ob_get_clean();
	}
